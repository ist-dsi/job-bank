	...
	<table class="tview-horizontal">
		...
		<logic:iterate id="sortedContact" name="sortedContacts">
			<tr>
				...
				<logic:iterate id="visibilityGroup" name="visibilityGroups">
					<td class="acenter">
					<%if (((module.contacts.domain.PartyContact)sortedContact).isVisibleTo((pt.ist.bennu.core.domain.groups.PersistentGroup)visibilityGroup)) {%>
...
<bean:message bundle="CONTACTS_RESOURCES" key="manage.contacts.addContact.label"/>
</html:link>
